...
<div class="form-group row">
    <div class="col-sm-10 offset-sm-2">
        <div class="image-preview" id="default_image_wrapper">
...
<div class="form-group row">
    <div class="col-sm-10 offset-sm-2">
        <div class="image-preview" id="facebook_image_wrapper">
...
<div class="form-group row">
    <div class="col-sm-10 offset-sm-2">
        <div class="image-preview" id="twitter_image_wrapper">
...
<div class="form-group row">
    <div class="col-sm-10 offset-sm-2">
        <div class="image-preview" id="instagram_image_wrapper">
...
<div class="form-group row">
    <div class="col-sm-10 offset-sm-2">
        <div class="image-preview" id="snapshot_image_wrapper">
...
<div class="form-group row">
    <div class="col-sm-10 offset-sm-2">
        <div class="image-preview" id="pinterest_image_wrapper">
