<section class="row section-logo">
  <div class="col-md-6 brand">
      <div class="logo">
        ...
        <span>Welcome to IBImages</span>
      </div>
      <p>Recording memories for everyone's future</p>
  </div>
  <div class="col-md-6 login-form">
      ...
      <div class="form-group">
        ...
        <div class="pull-right col-sm-3 text-right col-xs-12">
            <?= $this->Form->button(__('Login'), ['class' => 'btn  col-xs-12']) ?>
        </div>
      </div>
      <div class="form-group">
        <div class="col-sm-3 text-right col-xs-12">
            <?= $this->Form->button('NFC', ['class' => 'btn col-xs-12'])?>
        </div>
        <div class="col-sm-9 text-left col-xs-12">
          <?= $this->Form->button('Scan Your NFC Card Here', ['class' => 'btn col-xs-12 btn-white'])?>
        </div>
      </div>
      <?= $this->Form->end() ?>
  </div>
...
<section class="section-social row container">
  ...
  <div class="col-xs-12 col-sm-6" id="google-map" style="text-align: center;">
